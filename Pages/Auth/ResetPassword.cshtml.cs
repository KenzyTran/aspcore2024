...
namespace Bestshop.Pages.Auth
{
    ...
    {
		[BindProperty, Required(ErrorMessage = "Vui lòng điền Mật khẩu")]
		[StringLength(50, ErrorMessage = "Mật khẩu phải có từ 5 đến 50 ký tự", MinimumLength = 5)]
		public string Password { get; set; } = "";

		[BindProperty, Required(ErrorMessage = "Vui lòng xác nhận lại mật khẩu")]
                ...
                using (SqlConnection connection = new SqlConnection(connectionString))
				{
					...
					using (SqlCommand command = new SqlCommand(sql, connection))
					{
						...
						using (SqlDataReader reader = command.ExecuteReader())
						{
							...
							{
								errorMessage = "Sai hoặc mã Token đã hết hạn";
								return;
							}	
						}
					}
